...
CREATE TABLE `users` (
  `name` varchar(1024) CHARACTER SET utf16 COLLATE utf16_unicode_ci NOT NULL,
  `kind` enum('UNDERGRAD','POSTGRAD','MENTOR','SENIOR_MENTOR','HONORARY_MENTOR','FACULTY') CHARACTER SET utf16 COLLATE utf16_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=777 DEFAULT CHARSET=utf16 COLLATE=utf16_bin;